 ...
 */
(function(b){b.reject=function(a){a=b.extend(true,{reject:{all:false,msie5:true,msie6:true,msie7:true},display:[],browserInfo:{firefox:{text:"Firefox 3.6+",url:"http://www.firefox.com"},safari:{text:"Safari 4",url:"http://www.apple.com/ru/safari/download/"},opera:{text:"Opera 10.6+",url:"http://www.opera.com/download/"},chrome:{text:"Chrome 5",url:"http://www.google.com/chrome/"},msie:{text:"Internet Explorer 10",url:"http://www.microsoft.com/rus/windows/internet-explorer/"},gcf:{text:"Google Chrome Frame",
...
closeURL:"#",closeESC:true,closeCookie:false,cookieSettings:{path:"/",expires:0},imagePath:"/bitrix/images/reject-ie/",overlayBgColor:"#000",overlayOpacity:0.8,fadeInTime:"fast",fadeOutTime:"fast"},a);if(a.display.length<1)a.display=["firefox","chrome","msie","safari","opera","gcf"];b.isFunction(a.beforeReject)&&a.beforeReject(a);if(!a.close)a.closeESC=false;var d=function(c){return(c.all?true:false)||(c[b.os.name]?true:false)||(c[b.layout.name]?true:false)||(c[b.browser.name]?true:false)||(c[b.browser.className]?
